LEXICON: dict[str, str] = {
    ...
    'additional_services': '<b>Дополнительные услуги автора канала «Копилка текстов»</b>\n\n'
                           'Я, Лена Солодкова, лидирую SMM-направление и развиваю корпоративных блог в компании Lerna '
                           '(Skillbox 2b2), пишу и редактирую статьи на фрилансе, а ещё развиваю личные проекты. И я '
                           'открыта к новым сотрудничествам. \n\n'
                           '⚡️<b>Консультация по карьерному росту и прочим вопросам, связанных с работой —'
                           ' 5 200₽ час</b>\n\n'
                           'Сотрудничаю с сервисом Upminder:\n'
                           'https://upminder.education/mentor/solodkova-elena\n\n'
                           'На связи остаёмся и после консультации, поддерживаем общение в чатике. \n\n'
                           'Записаться можно на сайте, через менеджера @elena_upminder или в личке '
                           'со мной @lena_solodkova\n\n'
                           '⚡️<b>Аудит телеграм-канала — 10 000₽</b>\n\n'
                           'Актуально, если вы ведёте личный канал или канал компании и хотите поменять стратегию, '
                           'обновить или добавить воронки, усилить контент. Мы предварительно созваниваемся и '
                           'обсуждаем запрос, далее я собираю и структурирую идеи, затем мы снова созваниваемся на '
                           'брейншторм и обсуждение. После поддерживаем общение в чатике — я готова помогать с '
                           'оформлением конкретных постов и отвечать на точечные вопросы. \n\n'
                           'Подробности и бронь в личке @lena_solodkova\n\n'
                           '⚡️<b>Менторство — 18 000₽</b>\n\n'
                           ...
                           'Актуально для тех, кто в сфере копирайтинга и digital-маркетинга:\n\n'
                           '— хочет найти работу, новых заказчиков, выйти на новый уровень дохода;\n'
                           '— обновить или создать портфолио;\n'
                           '— завести личный блог и развивать личный бренд с его помощью.\n\n'
